...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (_utilities.utilities.storageAvailable) {
	    _utilities.utilities.saveToStorage();
	}
	
	_modules2.default.init();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  init: function init() {
	    ...
	    try {
	      for (var _iterator = dataModules[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var dataModule = _step.value;
	
	        var name = dataModule.dataset.module;
	        try {
	          var _module = this.modules[name](dataModule);
	        } catch (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function Drag(el) {
	  ...
	  this.el = el;
	  var drake = dragula([document.querySelector('#dragArea'), document.querySelector('#contentArea')], {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Block = __webpack_require__(5);
	var Drag = __webpack_require__(3);
	var block = void 0,
	    contentArea = void 0,
	    drag = void 0;
	...
	var utilities = {
	  populateStorage: function populateStorage() {
	    ...
	    // console.log(localStorage.emailTemplate);
	
	    contentArea.innerHTML = localStorage.emailTemplate;
	    contentArea.querySelectorAll('block');
	    // console.log(contentArea);
	    var blockLength = contentArea.querySelectorAll('.block');
	    for (var bl = 0; bl < blockLength.length; bl++) {
	      block = new Block(blockLength[bl]);
	    }
	    // drag = new Drag(document.getElementsByClassName('drag-container')[0])
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EditDivider = __webpack_require__(6);
	var EditImage = __webpack_require__(7);
	var EditText = __webpack_require__(8);
	var Save = __webpack_require__(11);
	var _editDivider = void 0,
	    _editImage = void 0,
	    _editText = void 0,
	    saveEmail = void 0,
	    save = void 0;
	...
	module.exports = function () {
	  ...
	  _createClass(Block, [{
	    ...
	    value: function editDivider(el) {
	      _editDivider = new EditDivider(el);
	    }
	  }, {
	    key: 'editImage',
	    value: function editImage(el) {
	      _editImage = new EditImage(el);
	    }
	  }, {
	    key: 'editText',
	    value: function editText(el) {
	      _editText = new EditText(el);
	    }
	  }, {
	    key: 'save',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ckeditor5BuildClassic = __webpack_require__(9);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  ...
	  _createClass(Save, [{
	    key: 'saveDivider',
	    value: function saveDivider(el) {
	      _utilities.utilities.setStorage();
	    }
	  }, {
	    key: 'saveImage',
	    value: function saveImage(el) {
	      _utilities.utilities.setStorage();
	    }
	  }, {
	    key: 'saveText',
	    value: function saveText(el) {
	      // console.log(el.querySelector('.ck-content'));
	
	      if (el.querySelector('.ck-content') !== null) {
	        var textContent = el.querySelector('.ck-content').innerHTML;
	        var ckCheck = new RegExp(/'cke-filler'/g);
	        // console.log(!textContent.match(ckCheck));
